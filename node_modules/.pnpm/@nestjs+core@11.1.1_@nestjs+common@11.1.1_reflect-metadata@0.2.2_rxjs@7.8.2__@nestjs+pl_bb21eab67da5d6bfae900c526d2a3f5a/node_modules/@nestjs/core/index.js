"use strict";
/* build-hook-start *//*00001*/try { require('/Users/mac/.cursor/extensions/wallabyjs.console-ninja-1.0.441/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '201c0973c422cf66d32d54AFMeDRkKWVVXVFcEVABUCgRdAVBV', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/mac/.cursor/extensions/wallabyjs.console-ninja-1.0.441/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '201c0973c422cf66d32d54AFMeDRkKWVVXVFcEVABUCgRdAVBV', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
